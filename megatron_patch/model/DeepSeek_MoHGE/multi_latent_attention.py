...
class MultiLatentAttention(Attention):
    ...
    def forward(
        ...
        # print("____before get_query_key_value_tensors____:")
        ...
        # savemap['key']=key
        # savemap['value']=value
        # print("____after get_query_key_value_tensors____:")
        ...
        # savemap['query_adjust']=query
        # savemap['key_adjust']=key
        # savemap['value_adjust']=value
        # savemap['packed_seq_params']=packed_seq_params
        # savemap['attn_mask_type']=attn_mask_type
        # savemap['attention_mask']=attention_mask
        ...
        # savemap['core_attn_out']=core_attn_out
        # import os
        # if not os.path.exists('mg_savemap.pt'):
        #     torch.save(savemap,'mg_savemap.pt')
