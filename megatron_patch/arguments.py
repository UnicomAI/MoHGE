...
def get_patch_args(parser):
    ...
    # group.add_argument("--moe-ffn-hidden-size", type=list, default=[512, 576, 640, 704, 768, 832, 896, 960])
    # group.add_argument("--moe-ffn-hidden-size", type=int, nargs='+', default=[512, 576, 640, 704, 768, 832, 896, 960])
    ...
    group.add_argument(
        ...
        type=int,
        default=1,
        help="attention backend default flash.",
    )
